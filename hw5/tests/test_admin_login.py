...
def test_admin_page_title(driver, base_url):
    ...
    AdminPage(driver).wait_title_contain(AdminPage.TITLE)


def test_admin_page_username_field(driver, base_url):
    driver.get(f'{base_url}{AdminPage.ADD_URL}')
    AdminPage(driver).wait_element(AdminPage.USERNAME_FIELD)


def test_admin_page_password_field(driver, base_url):
    driver.get(f'{base_url}{AdminPage.ADD_URL}')
    AdminPage(driver).wait_element(AdminPage.PASSWORD_FIELD)


def test_admin_page_login_btn(driver, base_url):
    driver.get(f'{base_url}{AdminPage.ADD_URL}')
    AdminPage(driver).wait_element(AdminPage.LOGIN_BTN)
...
def test_admin_login(driver, base_url):
    ...
    AdminPage(driver).wait_element(DashboardPage.LOGOUT_BTN)
